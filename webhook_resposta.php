  GNU nano 7.2 webhook_resposta.php
  <?php
    // 🚨 DEFINIÇÃO DO FUSO HORÁRIO BRASILEIRO (América/São Paulo) 🚨
    ...
    {
        global $error_file;
        // O date() usará o fuso horário definido acima.
    ...
    if ($resposta !== null && $numero !== null) {
        ...
        // O date() usará o fuso horário definido acima, garantindo a hora brasileira no DB.
